...
object Main {
  ...
  case class Output(id: Ident, t: Any, loc: Location)   // id, type, binding
  case class InValue(in: String)
  case class Location(loc: String)
  case class SysTask(task: String)
  case class SubTask(id: Ident, task: String)
